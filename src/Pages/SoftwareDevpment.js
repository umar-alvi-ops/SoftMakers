      ...
      <div className='Container-fluid mt-5 bg-primary'>
        <div className='row'>
          <div className='col-md-6 mt-5 pt-5 text-center'>
            <h1 className='text-center font-weight-bold mt-5 text-white' style={{fontSize:'40px' }}>SOFTWARE DEVELOPMENT</h1>
...
export default SoftwareDevpment
